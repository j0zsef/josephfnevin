import { getCurrentInstance, toRef, isRef, defineAsyncComponent, version, defineComponent, h, inject, computed, unref, Suspense, nextTick, Transition, provide, reactive, ref, resolveComponent, shallowRef, useSSRContext, createApp, onErrorCaptured, withCtx, createVNode } from 'vue';
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }, { "name": "description", "content": "Personal website for Joseph Nevin" }], "link": [{ "rel": "icon", "type": "image/x-icon", "href": "/favicon.ico" }], "style": [], "script": [], "noscript": [], "title": "Joseph Nevin", "htmlAttrs": { "lang": "en" } };
...
const _routes = [
  {
    name: (_a = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) != null ? _a : "contact",
    path: (_b = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) != null ? _b : "/contact",
    file: "/Users/jnevin/Projects/josephfnevin/pages/contact.vue",
    children: [],
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./_nuxt/contact.b189d8fc.mjs').then((m) => m.default || m)
  },
  {
    ...
    file: "/Users/jnevin/Projects/josephfnevin/pages/index.vue",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/index.f03aa9c3.mjs').then((m) => m.default || m)
  }
];
...
const ipxRuntime$nVHrLJNYqP = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  validateDomains,
  supportsAlias
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$nVHrLJNYqP, defaults: {} }
};
...
const layouts = {
  default: () => import('./_nuxt/default.f9f058ae.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.bd202b13.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { __appConfig as _, useState as a, _export_sfc as b, __nuxt_component_0$1 as c, entry$1 as default, parseSize as p, useNuxtApp as u };
