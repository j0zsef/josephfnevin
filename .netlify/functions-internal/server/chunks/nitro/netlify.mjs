...
import { parseURL, withQuery, joinURL, withLeadingSlash } from 'ufo';
import { eventHandler, setHeaders, sendRedirect, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, lazyEventHandler, createApp, createRouter as createRouter$1, toNodeListener } from 'h3';
...
const _CAPsPX = lazyEventHandler(() => {
  const ipxOptions = {
...
const _lazy_DkKr4a = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_DkKr4a, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _CAPsPX, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_DkKr4a, lazy: true, middleware: false, method: undefined }
];
